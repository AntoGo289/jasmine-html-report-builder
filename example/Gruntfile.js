...
module.exports = function(grunt) {
    ...
    grunt.registerTask('genReport', function() {
        ...
        var userDefinedDirs = [{ src: '/Users/Anto/Documents/testOutput/combined' }];
        var userDefinedButtons = [{ onClickLocation: 'combined', buttonText: 'Unit Test Results' }];
        ...
        var config = {
            ...
            userDefinedDirs: userDefinedDirs,
            userDefinedButtons: userDefinedButtons,
            browsersConfig: [{
